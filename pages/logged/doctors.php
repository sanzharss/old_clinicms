...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            ...
            <div class="col-xs-3">
              <label for="ex2">Добавить нового врача</label>
               <input class="form-control" id="ex2" name="iin" type="text"  required placeholder="Введите ИИН">
              <br>
              <input class="form-control" id="ex2" name="name" type="text" required placeholder="Имя">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <?php
                $sqlAllClinics="SELECT * FROM `users` where  statusId='1' and status!='0' and organizationId='$user->organizationId'";
