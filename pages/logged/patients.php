        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            ...
            <div class="col-xs-3">
              ...
              <input required class="form-control" id="ex2" type="text" name="iin" placeholder="Введите ИИН">
              <br>
              <input required class="form-control" id="ex2" type="text" name="name" placeholder="Имя">
              <br>
              <input required class="form-control" id="ex2" type="text" name="surname" placeholder="Фамилия">
              <br>
              <input required class="form-control" id="ex2" type="text" name="patr" placeholder="Отчество">
              <br>
              <input required class="form-control" id="ex2" type="date" name="date" placeholder="Дата рождения(гггг-мм-дд)">
              <br>
              ...
              <br>
              <input required class="form-control" id="ex2" type="text" name="address" placeholder="Адрес">
              <br>
            ...
            <table class="table table-striped">
              <thead>
               ...
               <tbody>
                <?php 
                $sqlPatients="select * from patient  where status='1'";
