        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="table-responsive">
            ...
            <div class="col-xs-3">
              ...
              <label >Пароль</label>
              <input required class="form-control" type="password" required id="ex2" name="password" value="<?php echo $rowSelectOrg->password; ?>" type="text" placeholder="Введите номер контактного телефона, факса с указанием кода города">
              <br>
